  ...
  <div className="flex justify-center w-full">
    <div className="flex flex-wrap justify-center gap-8 max-w-[1600px]">
      {filteredDatasets.map((dataset) => (
        <div
          key={dataset._id}
          className="bg-white shadow-lg rounded-2xl overflow-hidden border border-gray-200 flex flex-col hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 w-72"
        >
          {/* Image with Badge */}
